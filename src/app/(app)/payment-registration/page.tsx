...
const Payment: React.FC = () => {
	...
	return (
		<form
			...
			className="flex flex-col h-screen items-center bg-gradient-to-r from-gray-200 to-gray-500 p-8 rounded-lg shadow-md"
		>
				...
				<div>
					...
					<input
						...
						{...register("accountId", {
							...
							min: {
								value: 1,
								message: "Numero da conta deve ser um número positivo",
							},
						})}
				...
				<div>
					...
					<input
						...
						{...register("value", {
							...
							min: {
								value: 0,
								message: "Valor do Pagamento deve ser maior ou igual a zero",
							},
						})}
						className="w-full mt-2 p-2 border border-gray-300 rounded-md"
					/>
